        ...
        <div class="row mb-8">
          <div class="col-md-12">
            <div class="d-md-flex justify-content-between align-items-center">
              ...
              <!-- button -->
              <div>
                <a href="{{ route('admin.blog-setting') }}" class="btn btn-light">Back to Product</a>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-12">
            ...
            <div class="card mb-6 card-lg">
              ...
              <div class="card-body p-6">
                ...
                <div class="mb-3">
                  ...
                  <textarea class="form-control" rows="3" placeholder="Citation"></textarea>
                </div>
                  <!-- input -->
                  <div class="mb-3">
            ...
            <div class="card mb-6 card-lg">
              ...
              <div class="card-body p-6">
                ...
                <!-- input -->
                <div class="mb-3">
                  <label class="form-label">Caracteristique</label>
                  <textarea class="form-control" rows="3" placeholder="Caractéristique"></textarea>
                </div>
