            ...
            <div class="row align-items-center mb-14">
              <div class="col-md-6">
                ...
                <div class="ms-xxl-14 me-xxl-15 mb-8 mb-md-0 text-center text-md-start">
                  ...
                  <p class="mb-0 lead">By powering the future of grocery with our retail partners, we give everyone
                    access
                    to
              ...
              <div class="col-md-4">
                ...
                <div class="card bg-light mb-6 border-0">
                  ...
                  <div class="card-body p-8">
                    ...
                    <p>Vivamus non risus id sapien egestas tempus id sed lla mus justo metus, suscipit non hendrerit.
                    </p>
                    <!-- btn -->
