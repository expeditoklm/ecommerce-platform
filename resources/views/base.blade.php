          ...
          <div class="col-md-2 col-xxl-2 text-end d-none d-lg-block">
            ...
            <div class="list-inline">
              <div class="list-inline-item me-5">
                ...
                <a href="{{ route('shop.wishlist') }}" class="text-muted position-relative">
          ...
          <div class="row g-4">
            <div class="col-6 col-sm-6 col-md-3">
              ...
              <ul class="nav flex-column">
                ...
                <li class="nav-item mb-2"><a href="{{ route('pages.about') }}" class="nav-link">About</a></li>
                <li class="nav-item mb-2"><a href="{{ route('pages.contact') }}" class="nav-link">Contact</a></li>
