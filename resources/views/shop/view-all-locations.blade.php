...
<main>
  ...
  <section class="my-lg-14 my-8">
    <div class="container ">
      ...
      <div class="row row-cols-2 row-cols-md-3 row-cols-lg-5 g-0 border border-2 border-primary rounded-3">
        <!-- card -->
        <div class="card  card-product h-100">
          <div class="card-body position-relative">
            ...
            <div class="text-center position-relative ">
              ...
              <!-- img -->
              <a href="{{ route('shop.single-location') }}"> <img src="../assets/images/products/product-img-1.jpg"
