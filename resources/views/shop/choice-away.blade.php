      ...
      <div class="row">
        ...
        <div class="offset-lg-1 col-lg-10 col-12">
          ...
          <div class="row mb-12">
            ...
            <div class="col-md-4">
              ...
              <div class="card bg-light mb-6 border-0">
                ...
                <div class="card-body p-8">
                  ...
                  <p>Troquer contre un :</p>
                  <!-- btn -->
                   <div class="form-check">
                        <!-- input --><input class="form-check-input" type="checkbox" value="">
                        <!-- label --><label class="form-check-label" for="checkAll"> Product </label>
                           
                   </div>
                   <div class="form-check">
                        <!-- input --><input class="form-check-input" type="checkbox" value="" >
                        <!-- label --><label class="form-check-label" for="checkAll"> Service  </label>
                   </div>
                  <a href="{{ route('shop.select-product') }}" class="btn btn-dark mt-2">Continuer</a>
                </div>
            ...
            <div class="col">
              <!-- text -->
              <p>Vous n'avez pas encore créer un compte ! <a href="{{ route('create.account') }}">Créer maintenant .</a></p>
            </div>
