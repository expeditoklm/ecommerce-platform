              ...
              <ul class="nav nav-pills nav-scroll border-bottom-0 gap-1 " id="nav-tab" role="tablist">
                ...
                <li class="nav-item ">
                  ...
                  <a href="#" class="nav-link" id="nav-snackMunchies-tab" data-bs-toggle="tab"
                    ...
                    aria-selected="false">Snack & Munchies</a>
                </li>
                <!-- nav item -->
                <li class="nav-item ">
                  <!-- nav link -->
                  <a href="#" class="nav-link" id="nav-bakery-tab" data-bs-toggle="tab" data-bs-target="#nav-bakery"
                    role="tab" aria-controls="nav-bakery" aria-selected="false">Bakery
                    & Biscuits</a>
                </li>
                <!-- nav item -->
                <li class="nav-item ">
                  <!-- nav link -->
                  <a href="#" class="nav-link" id="nav-tea-tab" data-bs-toggle="tab" data-bs-target="#nav-tea"
                    role="tab" aria-controls="nav-tea" aria-selected="false">Tea, Coffee &
                    Drinks </a>
                </li>
                <!-- nav item -->
                <li class="nav-item">
                  <!-- nav link -->
                  <a href="#" class="nav-link" id="nav-drinks-tab" data-bs-toggle="tab" data-bs-target="#nav-drinks"
                    role="tab" aria-controls="nav-drinks" aria-selected="false">Cold
                    Drinks & Juices</a>
                </li>
                  ...
                  <div class="card-body position-relative">
                    ...
                    <div class="text-center position-relative ">
                      ...
                      <div class="product-action-btn">
                        ...
                        <a href="{{ route('shop.select-product') }}" class="btn-action" data-bs-toggle="tooltip"
                          data-bs-html="true" title="Compare"><i class="bi bi-arrow-left-right"></i></a>
                      </div>

                    </div>
                    <!-- title -->
                    <h2 class="fs-6"><a href="{{ route('shop.single', ['uuid' => "rui"]) }}"
                    ...
                    <div>
                      ...
                      <small class="text-warning"> <i class="bi bi-star-fill"></i>
                        ...
                        <i class="bi bi-star-fill"></i>
                        <i class="bi bi-star-fill"></i>
                        <i class="bi bi-star-half"></i></small> <span class="text-muted small">4.5(Nom de la
                        boutique)</span>
                    </div>
                    <!-- price -->
                  ...
                  <div class="card-body position-relative">
                    ...
                    <div>
                      ...
                      <small class="text-warning"> <i class="bi bi-star-fill"></i>
                        ...
                        <i class="bi bi-star-fill"></i>
                        <i class="bi bi-star-fill"></i>
                        <i class="bi bi-star-half"></i></small> <span class="text-muted small">4.4(Nom de la
                        boutique)</span>
                    </div>
                    <!-- price -->
                    <div class="d-flex justify-content-between align-items-center mt-3">
                  ...
                  <div class="card-body position-relative">
                    ...
                    <div>
                      ...
                      <small class="text-warning"> <i class="bi bi-star-fill"></i>
                        ...
                        <i class="bi bi-star-fill"></i>
                        <i class="bi bi-star-fill"></i>
                        <i class="bi bi-star-half"></i></small> <span class="text-muted small">4.7(Nom de la
                        boutique)</span>
                    </div>
                    <!-- price -->
                    <div class="d-flex justify-content-between align-items-center mt-3">
